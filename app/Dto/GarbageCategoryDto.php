...
class GarbageCategoryDto extends Dto
{
    public $model = GarbageCategoryModel::class;
    ...
    {
        return $this->query->whereKey($categoryId)->macroFirst();
    }
    ...
    {
        return $this->query->whereKey($categoryId)->update([
            'name' => $categoryName
        ]);
    }
    ...
    {
        return $this->query->whereKey($categoryId)->delete();
    }
}